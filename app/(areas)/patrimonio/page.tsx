...
import { ACERVO, ALMOXARIFADO, AREAS, GESTAO_DO_BEM, ROTEIROS_CONTABEIS } from "../../../lib/navegacao";
...
const ITENS: readonly ItemHub[] = [
  ...
  // ⚠️ ENT11 — os roteiros do eixo financeiro. Vêm da MESMA lista que alimenta a busca
