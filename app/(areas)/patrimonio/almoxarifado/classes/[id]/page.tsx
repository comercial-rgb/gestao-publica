...
import { verClasseDeMaterial, opcoesDoAlmoxarifado } from "../../../../../../lib/portas/recursos/almoxarifado-dados";
...
export default async function Detalhe({
  ...
  const [detalhe, opcoes, permitidas] = await Promise.all([
    ...
    acoesPermitidas(CLASSES_DE_MATERIAL.acoes.map((a) => a.acaoDoCenso)),
  ]);
