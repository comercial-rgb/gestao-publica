...
import { verUnidadeDeMedida, opcoesDoAlmoxarifado } from "../../../../../../lib/portas/recursos/almoxarifado-dados";
...
export default async function Detalhe({
  ...
  const [detalhe, opcoes, permitidas] = await Promise.all([
    ...
    acoesPermitidas(UNIDADES_DE_MEDIDA.acoes.map((a) => a.acaoDoCenso)),
  ]);
