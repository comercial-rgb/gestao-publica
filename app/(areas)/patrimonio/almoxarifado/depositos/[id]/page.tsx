...
import { verDeposito, opcoesDoAlmoxarifado } from "../../../../../../lib/portas/recursos/almoxarifado-dados";
...
export default async function Detalhe({
  ...
  const [detalhe, opcoes, permitidas] = await Promise.all([
    ...
    opcoesDoAlmoxarifado({ depositoId: id }),
    acoesPermitidas(DEPOSITOS.acoes.map((a) => a.acaoDoCenso)),
  ]);
